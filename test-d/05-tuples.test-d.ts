...
expectType<[string, boolean, ...number[], string]>(validate(tuple([string, boolean, ...number, string] as const), null))
expectType<[string, boolean, number, ...string[]]>(validate(tuple([string, boolean, number, ...string] as const), null))
expectType<[string, ...(boolean | number)[], string]>(
  validate(tuple([string, ...boolean, ...number, string] as const), null),
)
expectType<[string, ...(boolean | string | number)[], string]>(
  validate(tuple([string, ...boolean, string, ...number, string] as const), null),
)
...
expectType<['foo', ...(boolean | number)[], 'bar']>(
  validate(tuple(['foo', ...boolean, ...number, 'bar'] as const), null),
)
expectType<['foo', ...(boolean | 'xxx' | number)[], 'bar']>(
  validate(tuple(['foo', ...boolean, 'xxx', ...number, 'bar'] as const), null),
)
